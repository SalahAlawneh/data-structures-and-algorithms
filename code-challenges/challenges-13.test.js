...
const standardizePhoneNumbers = (arr) => arr.map(e => e.replace(/[() -]/g, ''));
...
const onlyOddChars = (str) =>  str.split('').filter((a, b) =>b % 2 !== 0 ? a : 0).join('');
...
const allHappy = (arr) => arr.every(e =>e.includes(':)'));
